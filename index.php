<?php
  ...
  $budget_fetched = mysqli_query($con, "SELECT * FROM budget WHERE user_id = '$userid'");
  $row = mysqli_fetch_assoc($budget_fetched);
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        <h3 class="mt-4">Expense Dashboard</h3>
        <div class="row">
          <div class="col-md">
            <div class="card">
              <div class="card-body">
                <div class="row">
                  <div class="col text-center" style="border: 2px solid black;">
                    <p><h1><b>Budget Amount: </b></h1></p>
                    <?php
                      
                      echo '<h2>'.$row['budgetamt'].'</h2>';
                    ?>
                  </div>
                  <div class="col text-center" style="border: 2px solid black;">
                    <p><h1><b>Total Spending: </b></h1></p>
                  <?php
                      echo '<h2>'.$row["totalexp"].'</h2>';
                    ?>
                  </div>
                </div>
              </div>
