...
<body>
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper" >
            ...
            <div class="container-fluid" style = "background-image: url(profbg.gif)">
                <div class="row justify-content-center" >
                    <div class="col-md-8" style = "border: 2px black solid; background-color: white; margin-top: 50px">
                    <h3 class="mt-4 text-center">Update Profile</h3>
                    <hr>
                        <form class="form" method="post" action="" enctype='multipart/form-data'>
                            <div class="text-center mt-3">
                                <img src="<?php echo $userprofile; ?>" class="text-center img img-fluid avatar" width="120" alt="Profile Picture">
                            </div>
                        ...
                        <form class="form" action="" method="post" id="registrationForm" autocomplete="off">
                            ...
                            <div class="form-group">
                                <div class="col-md">
                                    <br>
                                    <button class="btn btn-block btn-md btn-success" style="border-radius:0%;" name="save" type="submit" onClick="disp()">Save Changes</button>
                                </div>
                            </div>
                        </form>
                        <!--/tab-content-->
            ...
            <h2 id="msg" style="text-align:center; width:100%"></h2>
                        <script>
                            function disp(){
                               document.getElementById('msg').innerHTML = "Changes Successfully Saved!";
                            }
                        </script>
        </div>
